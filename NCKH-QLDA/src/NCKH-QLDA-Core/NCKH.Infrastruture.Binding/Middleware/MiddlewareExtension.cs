...
namespace NCKH.Infrastruture.Binding.Middleware
{
    public static class MiddlewareExtension
    {
        public static void GHMWelcome(this IApplicationBuilder app)
        {
            ...
            {
                await context.Response.WriteAsync(@"<head><title>HUMG Mo Dia Chat</title> <link href=""/swagger-ui/logo.ico"" type=""image/x-icon"" rel="" shortcut icon ""></head>
